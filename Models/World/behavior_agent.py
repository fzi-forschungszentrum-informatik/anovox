...
from Models.World.basic_agent import BasicAgent
from Models.World.behavior_types import (
    Cautious,
    Aggressive,
    Normal, Anomaly,
)
from Models.World.local_planner import RoadOption
from Models.World.misc import get_speed, positive
...
class BehaviorAgent(BasicAgent):
    ...
    def __init__(
        ...
        elif behavior == "anomaly":
            self._behavior = Anomaly()
    ...
    def traffic_light_manager(self):
        ...
        (
            affected,
            _,
        ) = self._affected_by_traffic_light(lights_list)
        ...
        if behind_vehicle_state and self._speed < get_speed(behind_vehicle):
            if (
                ...
                if not new_vehicle_state:
                    logging.info("Tailgating, moving to the right!")
                ...
                if not new_vehicle_state:
                    logging.info("Tailgating, moving to the left!")
                    end_waypoint = self._local_planner.target_waypoint
                    self._behavior.tailgate_counter = 200
                    self.set_destination(
                        end_waypoint.transform.location,
    ...
    def car_following_manager(self, vehicle, distance, debug=False):
        ...
        # TODO: Check why it is never defined
        self._speed_limit = 1000
    ...
    def run_step(self, debug=False):
        ...
        (
            ...
            walker,
            w_distance,
        ) = self.pedestrian_avoid_manager(ego_vehicle_wp)
        ...
        # 3: Intersection behavior
                ...
                self._incoming_waypoint
                and self._incoming_waypoint.is_junction is not None
                and (
                        self._incoming_direction
                        in [
                            RoadOption.LEFT,
