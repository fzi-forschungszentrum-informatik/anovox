...
from Models.World.controller import (
...
class LocalPlanner(object):
    ...
    def set_speed(self, speed):
        ...
        if self._follow_speed_limits:
            logging.warning(
                "The max speed is currently set to follow the speed limits. " "Use 'follow_speed_limits' to deactivate this")
