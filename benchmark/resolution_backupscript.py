...
def main(args):
    ...
    if args.datatype == 'image':
        ...
        for i, sem_img in enumerate(semantic_images):
        ...
        for i, sem_pcd in enumerate(semantic_pointclouds):
            file_name = "image_voxel_gt_" + os.path.basename(str(sem_pcd))
            file_path = os.path.join(output_dir, file_name)
...
if __name__ == "__main__":
    ...
    # subparser?
    parser.add_argument('--datatype', type=str, choices=['image', 'lidar'])
